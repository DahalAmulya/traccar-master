    ...
    await Promise.all(
      item.notificators.split(/[, ]+/).map(async (notificator) => {
        const response = await fetch(
          `http://108.181.186.122:8082/api/notifications/test/${notificator}`,
          {
            method: "POST",
          ...
          <Accordion defaultExpanded>
            ...
            <AccordionDetails className={classes.details}>
              <SelectField
                ...
                endpoint="http://108.181.186.122:8082/api/notifications/types"
              ...
              <SelectField
                ...
                endpoint="http://108.181.186.122:8082/api/notifications/notificators"
                keyGetter={(it) => it.type}
              ...
              {item.notificators?.includes("command") && (
                <SelectField
                  ...
                  endpoint="http://108.181.186.122:8082/api/commands"
          ...
          <Accordion>
            ...
            <AccordionDetails className={classes.details}>
              <SelectField
                ...
                endpoint="http://108.181.186.122:8082/api/calendars"
